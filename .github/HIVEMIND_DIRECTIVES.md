...
**FULL COMPLETION:** Run tests, fix errors, and submit PR without waiting.
**SELF-CORRECTION:** If tests fail, fix and retry automatically until passing.
...
**INITIALIZATION STEP:** Check 'knowledge_base.md' for past mistakes and learned patterns before writing a single line of code.
